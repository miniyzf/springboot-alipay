...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="<%=basePath%>alipayMent" method=post
			target="_blank">
		...
		<form name=tradequery action="<%=basePath%>tradeQuery" method=post
			target="_blank">
		...
		<form name=traderefund action="<%=basePath%>tradeRefund" method=post
			target="_blank">
		...
		<form name=traderefundquery action="<%=basePath%>tradeRefundQuery" method=post
			target="_blank">
		...
		<form name=tradeclose action="<%=basePath%>tradeClose" method=post
			target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDbody").value = "橘子";
	}
	GetDateNow();
</script>
</html>